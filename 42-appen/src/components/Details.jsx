// function Details() {
//   return (
//     <form className="w-1/3 space-y-6 max-w-2xl mx-auto">
//       <div>
//         <label
//           htmlFor="title"
...
function Details() {
  return (
    <form className="w-full max-w-2xl space-y-6 mx-auto">
      {["Title", "Category", "Provider", "Offer description"].map(
        (label, index) => (
          <div key={index}>
            <label
      ...
      <div className="flex flex-wrap -mx-2">
        {["Start date", "End date (optional)"].map((label, index) => (
      ...
      <div>
        ...
        {["Live", "Inactive", "Expired"].map((status, index) => (
